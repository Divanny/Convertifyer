  ...
  <div class="mx-auto flex justify-center	content-center max-w-2xl h-full flex-wrap">
    <div class="text-center h-fit">
      ...
      <div class="mt-10 sm:px-0 sm:mx-0 md:px-10 md:mx-10 lg:px-8 lg:mx-10">
        <file-pond v-bind:files="file" ref="filePond" dropOnPage="true" dropOnElement="false" credits="false" accepted-file-types="text/html" fileValidateTypeLabelExpectedTypes="Expects HTML format" labelIdle='Drag & Drop your HTML file or <span class="filepond--label-action"> Browse </span>'/>
